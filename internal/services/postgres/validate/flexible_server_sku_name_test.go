...
func TestFlexibleServerSkuName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: "Standard_D64s_v3",
			valid: true,
		},
		{
			name:  "Standard_D16ds_v4",
			input: "Standard_D16ds_v4",
			valid: true,
		},
		{
			name:  "Standard",
		...
		{
			name:  "Standard_E64ds_v3",
			input: "Standard_E64ds_v3",
			valid: false,
		},
		{
			name:  "Standard_B1ms",
		...
		},
		{
			...
			input: "Standard_E16ds_v4",
			valid: true,
		},
		{
			name:  "Standard_B20ms",
			input: "Standard_B20ms",
			valid: true,
		},
		{
			name:  "Standard_D16ds_v5",
			input: "Standard_D16ds_v5",
			valid: true,
		},
		{
			name:  "Standard_D16ads_v5",
			input: "Standard_D16ads_v5",
			valid: true,
		},
		{
			name:  "Standard_E16ds_v5",
			input: "Standard_E16ds_v5",
			valid: true,
		},
		{
			name:  "Standard_E16ads_v5",
			input: "Standard_E16ads_v5",
			valid: true,
		},
	}
